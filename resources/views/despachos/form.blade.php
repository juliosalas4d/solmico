                ...
                <div class="panel-body">
                    <div class="table-container">
                        <form method="POST" action="{{ route('despachos.update', $despacho->iddesp) }}"  role="form">
                            ...
                            <div class="form-group" align="center">
                                <a class="btn btn-info" href="{{ route('despachos.index') }}">Atrás</a>
                                <button class="btn btn-success" type="submit" >Actualizar</button>

                                <button type="button" class="btn btn-warning" title="Imprimir Planillas" data-toggle="modal" data-target="#imprimirModal">
                                  Imprimir
                                </button>
