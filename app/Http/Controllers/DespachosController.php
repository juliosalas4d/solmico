...
class DespachosController extends Controller
{
    ...
    public function show($id)
    {
        ...
        return view('despachos.show', compact('despacho', 'autorizado', 'chofer', 'lote', 'producto', 'transportista', 'unidad', 'chuto', 'proyecto'));
    ...
    public function htmlfgc160()
    {
        return view('fgc160.html');
    }
 
    public function generatefgc160()
    {
        $data = ['title' => 'Cartificado de Análisis de Laboratorio'];
        $pdf = PDF::loadView('despachos/fgc160', $data);
        return $pdf->download('fgc160.pdf');
    }
    ...
    {   
        ...
        return view('fgc160.html', compact('despacho', 'autorizado', 'chofer', 'lote', 'producto', 'transportista', 'unidad', 'chuto', 'proyecto'));

        //return view('despachos/fgc161');
    }
 
    public function generatefgc161()
    {
        $data = ['title' => 'Guía de despacho de Productos Químicos'];
        $pdf = PDF::loadView('despachos/fgc161', $data);
        return $pdf->download('fgc161.pdf');
    }
}
