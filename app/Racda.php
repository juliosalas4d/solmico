...
class Racda extends Model
{
	...
	*/
	protected $primaryKey = 'idracda';
 
	// Denimos los campos de la tabla directamente en la variable de tipo array $fillable
	protected $fillable = array('racda', 'nombre', 'repre', 'cargo', 'dir', 'telf', 'fax', 'email', 'oficio', 'fecha', 'tipo', 'obs', 'usuario', 'activo');
