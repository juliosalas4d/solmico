...
class Despachos extends Model
{
	...
	*/
	...
	protected $fillable =  array('iddesp', 'fechasal', 'idproducto', 'idlote', 'idproyecto', 'arearec_1', 'arearec_2', 'arearec_3', 'cant_des', 'idunidad', 'cant_ent', 'idtransp', 'placach', 'placare', 'cedcho', 'prescintos', 'cedaut', 'boleto', 'tara', 'bruto', 'nde', 'obs', 'activo');
