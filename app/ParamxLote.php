...
class ParamxLote extends Model
{
	...
	*/
	protected $primaryKey = 'idpxl';
 
	// Denimos los campos de la tabla directamente en la variable de tipo array $fillable
	protected $fillable =  array('idlote', 'idproducto', 'idparam1', 'valor1', 'idparam2', 'valor2', 'idparam3', 'valor3','idparam4', 'valor4','idparam5', 'valor5','idparam6', 'valor6','idparam7', 'valor7','idparam8', 'valor8','idparam9', 'valor9','idparam10', 'valor10', 'obs', 'activo');
